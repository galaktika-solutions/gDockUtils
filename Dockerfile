...
RUN pip3 install --no-cache pyyaml==3.13
RUN addgroup -g 8000 django && adduser -D -H -u 8000 -G django django
RUN addgroup -g 1443 nginx && adduser -D -H -u 1443 -G nginx nginx
